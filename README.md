...
[![copying.md](https://img.shields.io/static/v1?label=license&message=CCBY-SA4.0&color=%23385177)](https://github.com/razvanvirtan/SMD/blob/master/COPYING.md)
[![copying.md](https://img.shields.io/static/v1?label=license&message=BSD-3-clause&color=%23385177)](https://github.com/razvanvirtan/SMD/blob/master/COPYING.md)
[![discord](https://img.shields.io/badge/users-93-7589D0?logo=discord)](www.bit.ly/OpenEduHub)
[![contributors](https://img.shields.io/github/contributors/open-education-hub/operating-systems)](https://github.com/razvanvirtan/SMD/graphs/contributors)
...
These are open educational resources ([OER](https://en.wikipedia.org/wiki/Open_educational_resources)) for Security of Mobile Devices classes.
They are to be used by teachers, trainers, students and hobbyists who want to learn about modern topics in the security of mobile devices.
...
* [Static Analysis - Android](content/chapters/software-stack/)
* [Mobile UI Security](content/chapters/data/)
* [Application Patching](content/chapters/compute/)
